...
file_upload_feedback.add_argument(
    "feedback_type", type=str, required=True, help="feedback_type"
)
file_upload_feedback.add_argument(
    "feedback_priority", type=str, required=True, help="feedback_priority"
)
file_upload_feedback.add_argument("title", type=str, required=True, help="title")
file_upload_feedback.add_argument(
    "description", type=str, required=True, help="description"
)
file_upload_feedback.add_argument(
    "file",
    type=werkzeug.datastructures.FileStorage,
