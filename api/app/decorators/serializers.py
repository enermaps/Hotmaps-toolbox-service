...
point_curve = api.model(
    "Point",
    {"X": fields.Float(description="X-axis"), "Y": fields.Float(description="Y-axis")},
)

values_by_hectare = api.model(
    "Value",
    {
...
input_component = api.model(
    "computation module component",
    {
...
compution_module_class = api.model(
    "computation module list",
    {
        "id": fields.Integer(
            readOnly=True, description="ID of the computation module register"
        ),
...
compution_module_list = api.model(
    "Input for population density for area",
    {"list": fields.List(fields.Nested(compution_module_class))},
)
input_component_list = api.model(
    "Input for population density for area",
    {"list": fields.List(fields.Nested(input_component))},
)


test_communication_cm = api.model(
    "Input for population density for area",
    {"custom": fields.String(description="custom")},
)


grid_properties = api.model(
    "Properties",
    {
...
multipolygon_geometry = api.model(
    "MultiPolygon",
    {
        "type": fields.String(),
...
points_in_area = api.model(
    "Point in area", {"geometry": fields.List(fields.Nested(points_geometry))}
)

crs_properties = api.model("properties", {"name": fields.String})
feature_collection_crs = api.model(
    "crs", {"type": fields.String, "properties": fields.Nested(crs_properties)}
)
grid_feature = api.model(
    "Feature",
    {
        "type": fields.String(),
...
grid_feature_collection = api.model(
    "FeatureCollection",
    {
        "type": fields.String(),
...
area = api.model("Input area", {"points": fields.List(fields.Nested(point))})
value_of_centroid_area_output = api.model(
    "Number of Centroid", {"value": fields.String()}
)
number_of_centroid_area_output = api.model(
    "Number of Centroid", {"count": fields.Integer()}
)
...
population_density = api.model(
    "Population density",
    {
        "id": fields.Integer(
            readOnly=True, description="ID of the population density object"
        ),
...
total_density_for_nuts_area = api.model(
    "Population density sum",
    {
        ...
        "sum_density": fields.Integer(
            attribute="sum_density", description="Sum of density for selected area"
        ),
        "geometries": fields.String(attribute="geometries"),
    },
)

total_density_for_nuts_area_input = api.model(
    "Input for population density for area",
    {
...
raster_for_area_input = api.model(
    "Input for population density for area",
    {
        "year": fields.Integer(description="Year"),
        "points": fields.List(fields.Nested(point)),
...
stats_layers_area_input = api.model(
    "Input for statistics on layers, area and year",
    {
...
aggregation_value = api.model(
    "Layer aggregation values",
    {
...
stats_layer_aggregation = api.model(
    "Layer aggregation",
    {
        "name": fields.String(description="Name"),
...
vector_feature_properties = api.model(
    "Feature properties",
    {
        "values": fields.List(fields.Nested(aggregation_value)),
    },
...
vector_feature_collection = api.model(
    "Feature collection",
    {
        "type": fields.String(),
        "crs": fields.Nested(feature_collection_crs),
...
stats_layers_output = api.model(
    "Stats for selected layers, year and area",
    {
...
stats_layers_hectares_output = api.model(
    "Stats for selected layers, year and area",
    {
        "layers": fields.List(fields.Nested(stats_layer_aggregation)),
...
stats_layer_personnal_layer = api.model(
    "personnal layer",
    {
...
stats_layer_personnal_layer_input = api.model(
    "Input for stats on personnal layer",
    {
...
stats_layers_area_nuts_input = api.model(
    "Input for statistics on layers, area and year",
    {
        "layers": fields.List(fields.String(description="Layer")),
...
stats_layer_point_input = api.model(
    "Input for statistics on layers, year, point",
    {
        "layers": fields.List(fields.String(description="Layer")),
        "nuts_level": fields.String(description="Nuts level"),
        "year": fields.Integer(description="Year"),
...
load_profile_aggregation_year_row = api.model(
    "Output row for load profile (for year)",
    {
...
load_profile_aggregation_year = api.model(
    "Output for load profile",
    {
...
load_profile_aggregation_year_input = api.model(
    "Input for load profile",
    {
        "year": fields.Integer(description="Year"),
        "nuts": fields.List(fields.String(descriptions="List of NUTS")),
        "nuts_level": fields.String(description="Nuts level"),
...
load_profile_aggregation_month_row = api.model(
    "Output row for load profile (for month)",
    {
...
load_profile_aggregation_month = api.model(
    "Output for load profile (for month)",
    {
...
load_profile_aggregation_month_input = api.model(
    "Input for load profile (for month)",
    {
        "year": fields.Integer(description="Year"),
        "month": fields.Integer(description="Month"),
        "nuts": fields.List(fields.String(descriptions="List of NUTS")),
...
load_profile_aggregation_day_row = api.model(
    "Output row for load profile (for day)",
    {
...
load_profile_aggregation_day = api.model(
    "Output for load profile (for day)",
    {
...
load_profile_aggregation_day_input = api.model(
    "Input for load profile (for day)",
    {
        "year": fields.Integer(description="Year"),
        "month": fields.Integer(description="Month"),
        "day": fields.Integer(description="Day"),
...
load_profile_aggregation_curve = api.model(
    "Input for load profile duration curve",
    {
        "year": fields.Integer(description="Year"),
        "nuts": fields.List(fields.String(descriptions="List of NUTS")),
    },
...
load_profile_aggregation_curve_output = api.model(
    "Output for load profile duration curve",
    {"points": fields.List(fields.Nested(point_curve))},
)

load_profile_aggregation_curve_hectares = api.model(
    "Input for load profile duration curve",
    {
        "year": fields.Integer(description="Year"),
...
load_profile_aggregation_hectares = api.model(
    "Input for load profile hectares",
    {
        "year": fields.Integer(description="Year"),
        "month": fields.Integer(description="Month"),
        "day": fields.Integer(description="Day"),
...
load_profile_aggregation_hectares_output = api.model(
    "Output for load profile hectares",
    {"values": fields.List(fields.Nested(load_profile_aggregation_day_row))},
)
...
stats_layers_nuts_output = api.model(
    "Stats for selected layers, year and area",
    {
        "layers": fields.List(fields.Nested(stats_layer_aggregation)),
        "no_data_layers": fields.List(fields.String(description="Layer")),
...
stats_list_label_dataset = api.model(
    "Output  list of labels and datasets",
    {
...
centroid_from_polygon_input = api.model(
    "get polygon in order to retrieve the centroid",
    {
        "centroids": fields.String(description="coordinates"),
    },
)

inputs_module = api.model(
    "inputs_module",
    {
...
input_computation_module = api.model(
    "Input for population density for area",
    {
...
user_register_output = api.model(
    "output for user registration",
    {
        "message": fields.String(description="message"),
    },
)

user_activate_input = api.model(
    "input for user activation",
    {
        "token": fields.String(description="token"),
    },
)

user_activate_output = api.model(
    "output for user activation",
    {
        "message": fields.String(description="message"),
    },
)

user_deletion_input = api.model(
...
user_deletion_output = api.model(
    "output for user deletion",
    {
        "message": fields.String(description="message"),
    },
)

user_ask_recovery_input = api.model(
    "input for user password recovery request",
    {
        "email": fields.String(description="email"),
    },
)

user_ask_recovery_output = api.model(
    "output for user password recovery request",
    {
        "message": fields.String(description="message"),
    },
)
...
user_recovery_output = api.model(
    "output for user password recovery",
    {
        "message": fields.String(description="message"),
    },
)
...
user_login_output = api.model(
    "output for user login",
    {
        "message": fields.String(description="message"),
        "token": fields.String(description="authentification token"),
    },
)
feedback_output = api.model(
    "output for user feedback", {"message": fields.String(description="message")}
)
user_logout_input = api.model(
    "input for the user logout",
    {
        "token": fields.String(description="authentification token"),
    },
)

user_logout_output = api.model(
...
user_profile_output = api.model(
    "output for user profile modifying",
    {
        "message": fields.String(description="message"),
    },
)

user_get_information_output = api.model(
    "output for getting user information",
    {
...
user_get_information_input = api.model(
...
upload_add_input = api.model(
    "input for uploads adding",
    {
        "token": fields.String(description="authentification token"),
...
upload_add_output = api.model(
    "output for uploads adding",
    {
        "message": fields.String(description="message"),
    },
)
...
upload_list_input = api.model(
    "input for uploads listing",
    {
        "token": fields.String(description="authentification token"),
    },
)

upload_list_output = api.model(
    "output for uploads listing",
    {
...
upload_space_used_output = api.model(
    "output for uploads space used function",
    {
...
upload_delete_input = api.model(
    "input for uploads deleting",
    {
        "token": fields.String(description="authentification token"),
        "id": fields.Integer(description="Upload id"),
...
upload_delete_output = api.model(
    "output for uploads deleting",
    {
        "message": fields.String(description="used size"),
    },
)
upload_export_raster_nuts_input = api.model(
    "input for the nuts upload export to raster",
    {
...
upload_export_raster_hectare_input = api.model(
    "input for the hectare upload export to raster",
    {
        "layers": fields.String(description="layer"),
        "year": fields.String(description="year"),
        "areas": fields.List(fields.Nested(area)),
...
upload_export_csv_nuts_input = api.model(
    "input for the nuts upload export to csv",
    {
        "layers": fields.String(description="layer"),
        "year": fields.String(description="year"),
...
upload_export_csv_hectare_input = api.model(
    "input for the hectare upload export to csv",
    {
        "layers": fields.String(description="layer"),
        "year": fields.String(description="year"),
        "schema": fields.String(description="schema"),
...
upload_export_cm_layer_input = api.model(
    "input for the upload export cm layer",
    {
...
upload_download_input = api.model(
    "input for the upload download.",
    {
        "token": fields.String(description="authentification token"),
        "id": fields.Integer(description="Upload id"),
    },
...
snapshot_add_input = api.model(
    "input for the snapshot's addition.",
    {
        "token": fields.String(description="authentification token"),
        "config": fields.String(description="snapshot content"),
    },
...
snapshot_add_output = api.model(
    "output for the snapshot's addition.",
    {
        "message": fields.String(description="confirmation's message"),
    },
)

snapshot_load_input = api.model(
    "input for the snapshot's load.",
    {
        "token": fields.String(description="authentification token"),
        "id": fields.Integer(description="Snapshot id"),
    },
...
snapshot_load_output = api.model(
    "output for the snapshot's load.",
    {
        "config": fields.String(description="config content"),
    },
)

snapshot_delete_input = api.model(
    "input for the snapshot's deletion.",
    {
        "token": fields.String(description="authentification token"),
        "id": fields.Integer(description="Snapshot id"),
    },
...
snapshot_delete_output = api.model(
    "output for the snapshot's deletion.",
    {
        "message": fields.String(description="response"),
    },
)

snapshot_update_input = api.model(
    "input for the snapshot's update.",
    {
        "token": fields.String(description="authentification token"),
        "config": fields.String(description="config content"),
        "id": fields.Integer(description="Snapshot id"),
...
snapshot_update_output = api.model(
    "output for the snapshot's update.",
    {
        "message": fields.String(description="response"),
    },
)

snapshot_list_input = api.model(
    "input for snapshot listing",
    {
        "token": fields.String(description="authentification token"),
    },
)

snapshot_list_output = api.model(
    "output for snapshot listing",
    {
