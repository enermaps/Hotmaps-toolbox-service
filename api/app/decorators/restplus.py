...
def handle_request_exception(error):
    ...
    response = {
        "message": message,
        "error": {"message": message, "status": "530", "statusText": "REQUEST"},
    }
    return response, 530
...
def handle_false_parameters(error):
    ...
    response = {
        "message": message,
        "error": {"message": message, "status": "531", "statusText": "PARAMETERS"},
    }
    return response, 531
...
def handle_intersection_request(error):
    ...
    response = {
        "message": message,
        "error": {"message": message, "status": "533", "statusText": "INTERSECTION"},
    }
    return response, 533
...
def handle_mail_existing(error):
    ...
    response = {
        "message": message,
        "error": {"message": message, "status": "535", "statusText": "USER EXISTING"},
    }
    return response, 535
...
def handle_activation_failure(error):
    ...
    response = {
        "message": message,
        "error": {"message": message, "status": "536", "statusText": "ACTIVATION"},
    }
    return response, 536
...
def handle_doesnt_own_upload(error):
    ...
    response = {
        "message": message,
        "error": {"message": message, "status": "540", "statusText": "USER NOT OWNER"},
    }
    return response, 540
...
def handle_upload_file_not_existing(error):
    ...
    response = {
        "message": message,
        "error": {"message": message, "status": "541", "statusText": "NO UPLOAD FILE"},
    }
    return response, 541
...
def handle_not_enough_space(error):
    ...
    response = {
        "message": message,
        "error": {"message": message, "status": "543", "statusText": "NO UPLOAD FOUND"},
    }
    return response, 543
...
def handle_timeout_reached():
    ...
    response = {
        "message": message,
        "error": {"message": message, "status": "545", "statusText": "TIMEOUT REACHED"},
    }
    return response, 545
