...
class TestUpdateSnapshot(TestCase):
    def test_post_working(self):
        ...
        payload = {"token": test_token, "id": test_snapshot_id, "config": "Hey"}
    ...
    def test_post_missing_parameter(self):
        ...
        """
        payload = {"tokfadsfasden": test_token, "ifdsad": -5, "configdasf": "Hey"}
    ...
    def test_post_not_existing_snapshot(self):
        ...
        """
        payload = {"token": test_token, "id": -5, "config": "Hey"}
    ...
    def test_post_user_unidentified(self):
        ...
        """
        payload = {"token": "toto", "id": -5, "config": "Hey"}
